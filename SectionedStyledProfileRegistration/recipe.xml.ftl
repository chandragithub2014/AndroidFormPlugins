...
<#if generateLayout>
      <instantiate from="root/res/layout/activity_simple_login.xml"
        ...
        <instantiate from="root/res/layout/fragment_sectioned_custom_profile.xml"
                     to="${escapeXmlAttribute(resOut)}/layout/fragment_sectioned_custom_profile.xml" />
...
<#else>
    ...
    <instantiate from="root/src/app_package/SectionedRegistrationStyledFragment.java.ftl"
                     to="${escapeXmlAttribute(srcOut)}/SectionedRegistrationStyledFragment.java" />
