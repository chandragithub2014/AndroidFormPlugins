...
<#if generateLayout>
      <instantiate from="root/res/layout/activity_simple_login.xml"
        ...
        <instantiate from="root/res/layout/login_facebook_type_layout.xml"
                     to="${escapeXmlAttribute(resOut)}/layout/login_facebook_type_layout.xml" />
</#if>
...
<#else>
    ...
    <instantiate from="root/src/app_package/FacebookTypeLoginFragment.java.ftl"
                     to="${escapeXmlAttribute(srcOut)}/FacebookTypeLoginFragment.java" />
