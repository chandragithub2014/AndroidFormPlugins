...
<#if generateLayout>
      <instantiate from="root/res/layout/activity_simple_login.xml"
        ...
        <instantiate from="root/res/layout/basic_login.xml"
                     to="${escapeXmlAttribute(resOut)}/layout/basic_login.xml" />
	   <instantiate from="root/res/layout/login_forgot_register_layout.xml"
                     to="${escapeXmlAttribute(resOut)}/layout/login_forgot_register_layout.xml" />				 
...
<#else>
    ...
    <instantiate from="root/src/app_package/BasicLoginFragment.java.ftl"
                     to="${escapeXmlAttribute(srcOut)}/BasicLoginFragment.java" />
