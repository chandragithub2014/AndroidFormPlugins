...
<#if generateLayout>
      <instantiate from="root/res/layout/activity_simple_login.xml"
        ...
        <instantiate from="root/res/layout/fragment_login_type3_form.xml"
                     to="${escapeXmlAttribute(resOut)}/layout/fragment_login_type3_form.xml" />
</#if>
...
<#else>
    ...
    <instantiate from="root/src/app_package/LoginType3Fragment.java.ftl"
                     to="${escapeXmlAttribute(srcOut)}/LoginType3Fragment.java" />
