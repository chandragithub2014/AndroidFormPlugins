...
<#if generateLayout>
      <instantiate from="root/res/layout/activity_simple_login.xml"
        ...
        <instantiate from="root/res/layout/fragment_simple_login.xml"
                     to="${escapeXmlAttribute(resOut)}/layout/fragment_simple_login.xml" />
</#if>
...
<#else>
    ...
    <instantiate from="root/src/app_package/SimpleLoginFragment.java.ftl"
                     to="${escapeXmlAttribute(srcOut)}/SimpleLoginFragment.java" />
</#if>
