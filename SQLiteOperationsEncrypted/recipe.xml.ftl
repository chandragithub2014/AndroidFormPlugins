...
<instantiate from="root/src/app_package/sqliteoperations/AESHelpers/AESHelper.java.ftl"
                     to="${escapeXmlAttribute(srcOut)}/sqliteoperations/AESHelpers/AESHelper.java" />	
<instantiate from="root/src/app_package/sqliteoperations/AESHelpers/AESUtil.java.ftl"
                     to="${escapeXmlAttribute(srcOut)}/sqliteoperations/AESHelpers/AESUtil.java" />						 
