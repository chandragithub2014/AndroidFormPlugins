...
<#if generateLayout>
      <instantiate from="root/res/layout/activity_simple_login.xml"
        ...
        <instantiate from="root/res/layout/fragment_profile_pic.xml"
                     to="${escapeXmlAttribute(resOut)}/layout/fragment_profile_pic.xml" />
...
<#else>
    ...
    <instantiate from="root/src/app_package/SectionedRegistrationProfilePicFragment.java.ftl"
                     to="${escapeXmlAttribute(srcOut)}/SectionedRegistrationProfilePicFragment.java" />
